...
class _DestinationScreenState extends State<DestinationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var act = activities.items
        .firstWhere((element) => element.city == widget.destination.city);
        ...
        children: <Widget>[
          ...
          Expanded(
            child: (
                    ...
                    //log(widget.destination.city);

                    //  if (activities.items[index].city == widget.destination.city) {
                    Column(
              children: <Widget>[
                Container(
