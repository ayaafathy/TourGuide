...
import 'package:homepage/widgets/destination_carousel.dart';
import 'package:homepage/widgets/hotel_carousel.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      BottomNavigationBar (currentIndex: _currentTab,
        ...
        items: [BottomNavigationBarItem(icon: Icon(Icons.search, size: 30,
      ),
        title: SizedBox.shrink(),
      ),
        BottomNavigationBarItem(icon: Icon(Icons.local_restaurant, size: 30,
        ),
          title: SizedBox.shrink(),
        ),
